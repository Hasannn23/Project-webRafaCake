                ...
                <table class="w-full text-left">
                    <thead class="bg-gray-50 text-gray-500 text-xs uppercase tracking-wider">
                        <tr>
                            ...
                            <th class="p-4 font-semibold">Promo</th>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50/50 transition">
                            ...
                            <td class="p-4">
                                @if($product->is_promo)
                                    <span class="px-2 py-1 text-xs rounded-full bg-green-100 text-green-700 font-medium">{{ $product->diskon }}% OFF</span>
                                @else
                            ...
                            <td class="p-4">
                                <div class="flex items-center gap-2">
                                    <form action="{{ route('admin.katalog.toggleStatus', $product->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
